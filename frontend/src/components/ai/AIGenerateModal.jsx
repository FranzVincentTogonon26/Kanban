...
const AIGenerateModal = ({
  ...
  const [columnId, setColumnId] = useState(getDefaultColumn);
        ...
        <div className="mt-5 space-y-2">
          ...
          <div className="max-h-72 space-y-2 overflow-y-auto pr-1">
            {suggestions.map((task, index) => (
              <div key={index} className="card rounded-2xl p-3.5">
          ...
          <div className="flex justify-end gap-2 pt-2">
            ...
            <Button onClick={addAll} loading={loading}>
              ...
              Add all to {columns.find((c) => c.id === columnId)?.title}
            </Button>
          </div>
        </div>
      )}
