        ...
        <div className="mx-auto max-w-[1600px] px-6 py-8 md:px-8">
          ...
          <div className="mb-6 flex flex-wrap items-center gap-2.5">
            <input
              ...
              className="h-9 w-56 rounded-full border border-line bg-surface px-4 text-sm shadow-[var(--shadow-card)] outline-none transition-all duration-200 focus:border-brand-500/50 focus:ring-2 focus:ring-brand-500/15"
            />
            <FilterSelect
              value={priority}
  ...
  return (
    ...
    >
      ...
      <div className="min-w-0 flex-1">
        ...
        {task.status && (
          <p className="mt-0.5 text-[12px] text-muted">{task.status}</p>
        )}
      </div>
      {due && (
        <span
          className={cn(
            "hidden items-center gap-1 rounded-full px-2.5 py-1 text-[12px] font-medium tabular sm:flex",
            due.overdue && !done
